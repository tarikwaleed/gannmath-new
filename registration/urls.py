...
urlpatterns = [
    ...
    path(
        "monthly", views.MonthlySubscriptionView.as_view(), name="monthly-subscription"
    ),
    path("annual", views.AnnualSubscriptionView.as_view(), name="annual-subscription"),
    path(
        "semi-annual",
        views.SemiAnnualSubscriptionView.as_view(),
    ...
    path(
        "monthly-standard-checkout",
        views.MonthlyStandardCheckoutView.as_view(),
        name="monthly-standard-checkout",
    ),
    path(
        "semi-annual-standard-checkout",
        views.SemiAnnualStandardCheckoutView.as_view(),
        name="semi-annual-standard-checkout",
    ),
    path(
        "annual-standard-checkout",
        views.AnnualStandardCheckoutView.as_view(),
        name="annual-standard-checkout",
    ),
